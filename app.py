...
machine = TocMachine(
    states=["user", "start", "choose", "initpig1", "initpig2", "initpig3", "rap", "deer", "princess", "rich"],
    transitions=[
        {
            "trigger": "advance",
            "source": ["user","rich"],
        ...
        {"trigger": "go_back", "source": ["choose", "initpig1", "initpig2", "initpig3", "rap", "deer", "princess","rich"], "dest": "start"},
    ],
    initial="user",
